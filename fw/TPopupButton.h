// ========================================================================================
//	TPopupButton.h			   Copyright (C) 2001-2003 Mike Voydanoff. All rights reserved.
// ========================================================================================
/*
...
#ifndef __TPopupButton__
#define __TPopupButton__
...
{
public:
						TPopupButton(TWindow* parent, const TRect& bounds, const TChar* title,
												TPopupMenu* menu);
	virtual 			~TPopupButton();
