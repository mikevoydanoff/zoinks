// ========================================================================================
//	TBroadcaster.cpp		   Copyright (C) 2001-2002 Mike Voydanoff. All rights reserved.
// ========================================================================================
/*
...
void TBroadcaster::AddListener(TListener* listener)
{
	ASSERT(listener);
	fListeners.Insert(listener);
	listener->AddBroadcaster(this);
}


void TBroadcaster::RemoveListener(TListener* listener)
{
	ASSERT(listener);
